...
if(($_SESSION['Authenticated'] === true) && ($_SESSION['SessionExp'] < time())){
  ...
  header('location: location: http://'.$_SERVER['HTTP_HOST'].'assets/lib/logout.php');
}
...
if ($_SESSION['Authenticated'] === true) {
    echo "<button onclick=\"location.href = 'http://".$_SERVER['HTTP_HOST']."/assets/lib/logout.php'\" style=\"width:auto;\">Logout</button>";
}else{
...
echo <<<_END
        ...
        <div class="container" style="background-color:#f1f1f1">
          ...
          <!-- <span class="psw">Forgot <a href="assets/lib/logout.php">password?</a></span> -->
        </div>
      </form>
    </div>
